-- FIRST: Run these statements to clean up existing tables
-- Execute one by one:
...
DROP POLICY IF EXISTS "Founders can insert milestones" ON milestones;
...
DROP INDEX IF EXISTS idx_startups_stage;

-- Then create the tables with this schema:
